-- Nivel 4 - DQL Avanzado: JOINs, subconsultas, vistas
-- Ejecutar: sqlite4 nivel4.db.sqlite3 < setup.sql
...
INSERT INTO estudiantes (nombre, apellido, email, fecha_nacimiento, activo) VALUES
    ...
    ('Fernando', 'Castillo', 'fernando.castillo@email.com', '2001-02-20', 1),
    ('Gabriela', 'Ortiz', 'gabriela.ortiz@email.com', '1998-10-11', 1),
    ('Hugo', 'Díaz', 'hugo.diaz@email.com', '2002-07-08', 1),
    ('Isabel', 'Flores', 'isabel.flores@email.com', '2000-12-25', 0);
